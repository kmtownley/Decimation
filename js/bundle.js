...
class Game {
  ...
  createBlossoms() {
    return Blossom.randomBlossom(0, Game.DIM_Y, Game.NUM_BLOSSOMS, this.ctx3);
  }
...
class Blossom {
  constructor(x, y, numBlosssoms, ctx3) {
    this.x = x;
...
Blossom.randomBlossom = (maxX, maxY, numBlossoms, ctx3) => {
