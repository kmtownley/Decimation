...
class Game {
  ...
  gameComplete() {
    this.pausedGame.style.display = "none";
    this.gameStopped = true;
    let gameCompletedMessage = document.getElementById("gameComplete");
    gameCompletedMessage.style.display = "inline-block";
    console.log(this.player.gemScore)
    this.Leaderboard.sendHighScores(this.player.gemScore);
  }
